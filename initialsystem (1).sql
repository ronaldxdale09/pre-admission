...
INSERT INTO `application_log` (`tracking_id`, `selectedCourse_id`, `user_id`, `college_id`, `course_id`, `file_id`, `userStatus`, `date`, `inter_score`, `rejectReason`, `interview_sched`) VALUES
(29, 10, 59, 1, 11, 7, 'PENDING', '2022:04:21', NULL, NULL, NULL),
(30, 10, 59, 1, 11, 7, 'PREQUALIFIED', '2022:04:21', NULL, NULL, NULL),
(31, 10, 59, 1, 11, 7, 'INTERVIEW', '2022:04:21', NULL, NULL, '1'),
(32, 10, 59, 1, 11, 7, 'QUALIFIED', '2022-04-22 ', '8', NULL, '1');
...
INSERT INTO `selectedcourse` (`selectedCourse_id`, `user_id`, `college_id`, `course_id`, `file_id`, `userStatus`, `date`, `ic`, `average`, `inter_score`, `rejectReason`, `interview_sched`, `academicYear`) VALUES
...
--
DELIMITER $$
CREATE TRIGGER `applicationlogs` AFTER UPDATE ON `selectedcourse` FOR EACH ROW INSERT into application_log VALUES (null,NEW.selectedCourse_id,NEW.user_id,NEW.college_id,NEW.course_id,NEW.file_id,NEW.userStatus,NEW.date,NEW.inter_score,NEW.rejectReason,NEW.interview_sched)
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `newSelectedCourse` AFTER INSERT ON `selectedcourse` FOR EACH ROW INSERT into application_log VALUES (null,NEW.selectedCourse_id,NEW.user_id,NEW.college_id,NEW.course_id,NEW.file_id,NEW.userStatus,NEW.date,NEW.inter_score,NEW.rejectReason,NEW.interview_sched)
$$
DELIMITER ;
...
--
ALTER TABLE `application_log`
  MODIFY `tracking_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
...
--
ALTER TABLE `selectedcourse`
  MODIFY `selectedCourse_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
