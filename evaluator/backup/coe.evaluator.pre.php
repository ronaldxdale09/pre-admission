    ...
    <header class="page-header">
        <nav>
          ...
          <ul class="admin-menu">
            ...
            <li>
              <a href="coe.evaluator.pre.php" class="active">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-body">
            <form action="coe.evaluator.pre.php" method="POST"> 
              <input type="id" name="userid" id="userid" style="display: none;">
              <?php $results2 = mysqli_query($db, "SELECT * from users WHERE user_type='coe-ic'") ?>
